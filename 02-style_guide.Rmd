...
take it too far with commenting, three levels will hardly be necessary. Also 
note that segments use roman numbers, sections arabic numbers and subsections 
letters.  The idea is that segments are represented by the thickest *lines* 
(since they represent the top level) and subsections are represented by 
*loose lines*. 
```{r}
# good
### ============================================================================
...
```
If not extremely complex, the user wants to know *why* someone does something, 
*how* (because he can read the code). Often, it makes sense organizing comments
in block instead of commenting every line.
...
web/packages/roxygen2/vignettes/roxygen2.html)]
